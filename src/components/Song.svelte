...
<div class="bg bg-[url('/smolnoise.svg')] md:bg-[url('/Np.svg')] rounded-2xl max-md:landscape:bg-[url('/Np.svg')] bg-no-repeat bg-contain flex items-center flex-col justify-center translate-y-0">
    ...
    <div class="absolute flex items-center w-[85%] md:w-auto max-md:landscape:w-auto md:flex-col max-md:landscape:flex-col max-md:landscape:absolute max-md:landscape:justify-center md:absolute md:justify-center">
        ...
        <img src="{image}" class=" min-w-[77px] w-[20%] -translate-x-[10%] md:translate-x-0 max-md:landscape:translate-x-0 md:w-[16vw] max-md:landscape:w-[16vw] max-w-[162px] rounded-xl md:rounded-lg max-md:landscape:rounded-lg songimg" alt = "">
        <div class="flex flex-col items-start md:items-center max-md:landscape:items-center">
        ...
        <span class="font-['Josefin_Sans'] text-[#F1A0CB] text-lg max-md:landscape:text-[1.6vw] tracking-wider text-center">{Artist}</span>
        </div>
    </div>
</div>
<style>
