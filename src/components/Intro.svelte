<script lang="ts">
    ...
    async function change(){
        ...
        while(true){
            ...
            for (let x = 0;x<traits[i].length;x++){
                adj = traits[i].slice(0,x)
                await sleep(100)
            }
            await sleep(700)
            i = i + 1
...
<div class="text-3xl font-semibold font-['Roboto'] tracking-[0.075em] md:tracking-[.12em] pt-10 text-white ">
